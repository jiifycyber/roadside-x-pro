...
class _Phase4ShellState extends State<Phase4Shell> {
  ...
  final menu = const [
    ...
    ('V18 Community Network', Icons.public),
    ('V14 Growth Integrations', Icons.link),
    ('V13 AI Call Center', Icons.support_agent),
    ('V12 Advanced AI', Icons.auto_awesome),
    ('V11 Intelligent Automation', Icons.psychology_alt_outlined),
  ...
  Widget _dashboard() => _page(
    ...
    'Live operations, financial performance, subscriptions, and company health.',
    Column(
      children: [
        LayoutBuilder(
